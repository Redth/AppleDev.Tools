...
{
	public override async Task<int> ExecuteAsync(CommandContext context, DeleteProvisioningProfileCommandSettings settings, CancellationToken cancellationToken)
	{
